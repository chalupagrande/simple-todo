...
import { Button, Checkbox, Dropdown, Typography, message } from "antd";
...
function ListsByIdPage({ user, parentList }) {
  ...
  const parent = data?.lists?.parent || {};
